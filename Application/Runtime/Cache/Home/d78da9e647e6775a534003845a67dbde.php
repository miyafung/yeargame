...
<div class="ecContent">
	<div class="ecCrumbs"><i>Current Position : </i> <span>Recent News > Flyin Group Draw Worldwide Attention in the 19th CIOE</span></div>
	<div class="ecProductModel">
		<div class="ecProductSideLeft">
			<h2>NEWS</h2>
			<ul class="ecProductSideUl">
				<li class="ecProductSideLi">
					<p><a class="ecSideWidth" href="javascript:;">Recent News</a></p>
				</li>
				<li class="ecProductSideLi">
					<p><a class="ecSideWidth" href="javascript:;">Company News</a></p>
				</li>
				<li class="ecProductSideLi">
					<p><a class="ecSideWidth" href="javascript:;">Industry News</a></p>
				</li>
			</ul>
		</div>
		<div class="ecModelDetailCon">
			<h3 class="ecModelDetailConTitle">Flyin Group Draw Worldwide Attention in the 19th CIOE</h3>
			<p class="ecModelDetailConTime">2017-12-12</p>
			<div class="ecModelDetailConData">
				<img src="/ecfiber/Public/Home/img/newDetail.jpg">
				<p>Flyin Optronics Co., Ltd sincerely invites you to visit our booth in ECOC in Gothenburg, Sweden from 18th-20th September, 2017. Our booth number is 191.</p>
				<p>ECOC, the largest conference on optical communication in Europe and one of the largest and most well-known events in this field worldwide, attracts numerous audiences every year. Many attendants who are interested in fiber optic components / fiber, cable / fiber optic active components / data communication / testing equipments / optical system etc will gather here to learn about the latest technology, most advanced products and meet new partners. ECOC is also a great entrance to open the European market.</p>
				<p>Flyin Group was established in 2005, is a high-tech enterprise and a leading worldwide manufacturer for fiber optic components. WDM: CWDM, DWDM, FWDM.Optical Splitters: PLC Splitter, FBT Coupler. Optical Patch Cord: MPO, LC, SC, FC, ST, MTRJ etc.Optical Switch:1x1, 1x2, 2x2, 2x2B etc.O ptical Transceivers, Media Converter, Optical Materials etc.</p>
			</div>
		</div>
...
$(function(){
	$('.ecNav li').eq(3).find('a').addClass('current');
	$('.ecProductSideLi').eq('0').find('a').addClass('current');
});
</script>
