...
<style class="cp-pen-styles">
	...
	.container { width: 1300px; position: absolute; top: 50%; left: 50%; margin-left: -650px; margin-top: -340px; }
	...
	.prizeBox { width: 480px; height: 680px; margin-right: 62px; }
	.orderBox { width: 728px; height: 680px; }
	...
	<div class="container">
		<div class="prizeBox">
			...
			<div class="prizeInfo">
				...
				<div class="prizeName">
                    <img src="/nianhui/Public/Home/img/10.png" width="220">
                </div>
				<div class="joinPhone">
                    <ul class="nextPrize">
                        <li>现金大奖</li>
...
<script>
    ...
    if(count == 0){
        $('.prizeName').text('');
        $('.prizeName').append('<img src="/nianhui/Public/Home/img/10.png" width="220">');
    }else{
