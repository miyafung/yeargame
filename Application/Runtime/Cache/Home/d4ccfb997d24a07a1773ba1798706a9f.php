    ...
    <div>
        ...
        <table width="946" height="79" border="0" style="margin: auto;">
            <tr>
                ...
                <td style="display: none;"><input name="text37" type="text" id="result_2"
                           class="randomShow"  size="20" readonly/>
                </td>
                <td style="display: none;"><input name="text38" type="text" id="result_3"
                           class="randomShow"   size="20" readonly/>
                </td>
                <td style="display: none;"><input name="text39" type="text" id="result_4"
                           class="randomShow"   size="20" readonly/>
                </td>
                <td style="display: none;"><input name="text40" type="text" id="result_5"
                           class="randomShow" size="20" readonly/>
                </td>
            </tr>
...
<script language="javascript">
    ...
    var timer;			//定时器时间
    var randnumOrders = new Array;			//初始化随机数组
    ...
    //把前面整合成字符串的参与抽奖人员 拆分为数组，以“，”为临界点进行分组  “/\s*[,，]\s*/g”该正则表达式的意思：去除空格，并与逗号为拆分标识
...
<script>
    ...
    var i = 1;
    var html = '';
    html += '<p><strong>第一轮中奖名单(20人)</strong></p>'
    html += '<table width="1200" height="30px" border="0" style="margin: auto;">'
    addHtml(2);
    html += '</table>'
    html += '<p><strong>第二轮中奖名单(20人)</strong></p>'
    html += '<table width="1200" height="30px" border="0" style="margin: auto;">'
    addHtml(2);
    html += '</table>'
    html += '<p><strong>第三轮中奖名单(10人)</strong></p>'
    html += '<table width="1200" height="30px" border="0" style="margin: auto;">'
    addHtml(10);
    html += '</table>'
