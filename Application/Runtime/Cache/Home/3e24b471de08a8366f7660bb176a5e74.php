...
<div class="ecContent">
	<div class="ecCrumbs"><i>Current Position : </i> <span>Recent News</span></div>
	<div class="ecProductModel">
		...
		<div class="ecNewModelList">
			<ul>
				<li>
					<a href="<?php echo U('News/newDetail');?>">
						<div class="ecNewModelListLiLeft">
							<img src="/ecfiber/Public/Home/img/new.png"/>
						</div>
						<div class="ecNewModelListLiRight">
							<h3>Flyin Group Draw Worldwide Attention in the 19th CIOE</h3>
							<p class="ecNewModelListLiCon">The19th CIOE (China International Optoelectronic Exposition) was held successfully in Shenzhen from 6th~9thSeptember, which is the largest exhibition in optoelectronic industry. Various exhibitors, visitors and professionals in optical communication industry gathered here from around the world to witness the development of optical communications, to show and to find the latest and the state of the art products. In this 110,000 square meter exhibition hall, over 60,000 attendants joined this big event to discuss about cooperation, opportunities, and visions.</p>
							<p class="ecNewModelListLiTime">2017-12-12</p>
						</div>
					</a>
				</li>
				<li>
