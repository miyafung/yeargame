	...
	<div class="container">
		<div class="prizeBox">
			...
			<div class="prizeInfo">
				...
				<div class="prizeName">
                    <img src="/game/Public/Home/img/10.png" width="330">
                </div>
				<div class="joinPhone">
                    <ul class="nextPrize">
                        <li>现金大奖</li>
...
<script>
    ...
    if(count == 0){
        $('.prizeName').text('');
        $('.prizeName').append('<img src="/game/Public/Home/img/10.png" width="330">');
    }else{
    ...
    /*for(var g =0; g<prizeArr.length; g++){
        ...
        if($('#cusList'+g).length >0){
            for(var f=0; f<$('#cusList'+g).length; f++){
                cusListB = '<img src="/game/Public/Home/img/person'+f+'.png">';
