...
<div class="ecContent">
	<div class="ecCrumbs"><i>Current Position : </i> <span>LTE SFP Transceivers</span></div>
	<div class="ecProductModel">
		<div class="ecProductSideLeft">
			<h2>PRODUCTS</h2>
			<ul class="ecProductSideUl">
				<li class="ecProductSideLi">
					<p><a href="javascript:;">PON Transceivers</a></p>
					<div class="ecProductSideLiBox">
						<ul>
							<li><a href="javascript:;">SFP+ Transceiver</a></li>
							<li><a href="javascript:;">CWDM SFP+ Transceiver</a></li>
							<li><a href="javascript:;">SFP+ Transceiver</a></li>
							<li><a href="javascript:;">CWDM SFP+ Transceiver</a></li>
						</ul>
					</div>
				...
				<li class="ecProductSideLi">
					<p><a href="javascript:;">LTE SFP Transceiver</a></p>
					<div class="ecProductSideLiBox">
						<ul>
							<li><a href="javascript:;">SFP+ Transceiver</a></li>
							<li><a href="javascript:;">CWDM SFP+ Transceiver</a></li>
				...
				<li class="ecProductSideLi">
					<p><a href="javascript:;">XFP Transceivers</a></p>
					<div class="ecProductSideLiBox">
						<ul>
							<li><a href="javascript:;">SFP+ Transceiver</a></li>
							<li><a href="javascript:;">CWDM SFP+ Transceiver</a></li>
				...
				<li class="ecProductSideLi">
					<p><a href="javascript:;">X2 Transceivers</a></p>
					<div class="ecProductSideLiBox">
						<ul>
							<li><a href="javascript:;">SFP+ Transceiver</a></li>
							<li><a href="javascript:;">CWDM SFP+ Transceiver</a></li>
				...
				<li class="ecProductSideLi">
					<p><a href="javascript:;">SFP Transceivers</a></p>
					<div class="ecProductSideLiBox">
						<ul>
							<li><a href="javascript:;">SFP+ Transceiver</a></li>
							<li><a href="javascript:;">CWDM SFP+ Transceiver</a></li>
				...
				<li class="ecProductSideLi">
					<p><a href="javascript:;">OEO Converter</a></p>
					<div class="ecProductSideLiBox">
						<ul>
							<li><a href="javascript:;">SFP+ Transceiver</a></li>
							<li><a href="javascript:;">CWDM SFP+ Transceiver</a></li>
		...
		<div class="ecProductModelList">
			<ul>
				<li>
					<a href="<?php echo U('Goods/productDetails');?>">
						<img class="ecProductModelListImage" src="/ecfiber/Public/Home/img/product.png">
						<div class="ecProductModelListCon">
							<p class="ecProductModelListConTitle"><span class="fa fa-circle"></span> FYSF-1524-C0BD</p>
							<img src="/ecfiber/Public/Home/img/productBt.png">
							<p class="ecProductModelListConList"><span class="fa fa-circle-o"></span> Switch to Switch interface</p>
							<p class="ecProductModelListConList"><span class="fa fa-circle-o"></span> Switched backplane applications</p>
						</div>
					</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo U('Goods/productDetails');?>">
						...
						<div class="ecProductModelListCon">
							<p class="ecProductModelListConTitle"><span class="fa fa-circle"></span> FYSF-1524-C0BD</p>
							<img src="/ecfiber/Public/Home/img/productBt.png">
							<p class="oecProductModelListConList"><span class="fa fa-circle-o"></span> Switch to Switch interface</p>
							<p class="ecProductModelListConList"><span class="fa fa-circle-o"></span> Switched backplane applications</p>
						</div>
					</a>
				</li>
			...
			<div class="ecPage">
				<div class="ecPagePrev"><b class="fa fa-angle-left"></b></div>
				<span class="current">1</span>
				<span>2</span>
				<span>3</span>
				<span>4</span>
				<div class="ecPageNext"><b class="fa fa-angle-right"></b></div>
...
$(function(){
	$('.ecNav li').eq(1).find('a').addClass('current');
	$('.ecProductSideLi').eq('1').find('a').addClass('current');

	var $imgLeft = '<img class="ecSideLeft" src="/ecfiber/Public/Home/img/sideLeft.png">';
	
	$('.ecProductSideLi').hover(function(){
		$(this).prepend($imgLeft);
		$(this).children('.ecProductSideLiBox').show().stop().siblings().children('.ecProductSideLiBox').hide();
	},function(){
		$(this).children('.ecProductSideLiBox').hide();
		$('.ecSideLeft').remove();
	});
